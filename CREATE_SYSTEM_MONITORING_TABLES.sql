...
-- تفعيل RLS (معطل مؤقتاً للاختبار)
-- ALTER TABLE system_metrics ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE system_alerts ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE backup_logs ENABLE ROW LEVEL SECURITY;

-- سياسات RLS بسيطة جداً
-- CREATE POLICY "system_metrics_policy" ON system_metrics FOR SELECT USING (true);
-- CREATE POLICY "system_alerts_policy" ON system_alerts FOR ALL USING (true);
-- CREATE POLICY "backup_logs_policy" ON backup_logs FOR SELECT USING (true);
...
INSERT INTO system_metrics (active_connections, total_requests, failed_requests, avg_response_time, cpu_usage, memory_usage, disk_usage, uptime_hours)
VALUES (38, 122000, 1320, 289.20, 45.6, 46.3, 34.9, 176);
...
INSERT INTO system_alerts (alert_type, title, description, action_required, resolved)
VALUES ('error', 'ارتفاع معدل الأخطاء', 'معدل الأخطاء تجاوز 1%، يتطلب تدخلاً فورياً', 'investigate', false);

INSERT INTO backup_logs (backup_type, status, file_size_bytes, duration_seconds)
VALUES ('automatic', 'completed', 524288000, 45);

INSERT INTO backup_logs (backup_type, status, file_size_bytes, duration_seconds)
VALUES ('manual', 'completed', 536870912, 52);