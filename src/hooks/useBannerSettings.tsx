...
type BannerRow = Database['public']['Tables']['banner_settings']['Row'];
type BannerInsert = Database['public']['Tables']['banner_settings']['Insert'];
type BannerUpdate = Database['public']['Tables']['banner_settings']['Update'];
...
export const useBannerSettings = () => {
  ...
  const { data: activeBanner, isLoading: isLoadingActive } = useQuery<BannerRow | null>({
  ...
  const { data: allBanners, isLoading: isLoadingAll } = useQuery<BannerRow[]>({
  ...
  const createBannerMutation = useMutation({
    mutationFn: async (newBanner: BannerInsert) => {
      const { data, error } = await supabase
        .from('banner_settings')
        .insert(newBanner)
        .select()
