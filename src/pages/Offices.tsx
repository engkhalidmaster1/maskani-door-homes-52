        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center gap-3 py-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold">المكاتب العقارية</h1>
            </div>
            ...
            <Button
              ...
              variant="ghost"
              className="text-primary-foreground hover:bg-white/20 border-2 border-white shrink-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="gradient-primary p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-lg font-bold text-primary-foreground line-clamp-1">{o.name}</h3>
                    </div>
                    {o.verified ? (
                      <Badge className="gap-1 bg-white/20 text-primary-foreground border-0">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {o.email && (
                        <div className="flex items-center gap-2 text-foreground">
                          ...
                          <a href={`mailto:${o.email}`} className="hover:text-primary transition-colors line-clamp-1">{o.email}</a>
                        </div>
                      )}
                      {o.website && (
                        <div className="flex items-center gap-2 text-foreground">
                          <Globe className="h-4 w-4 text-primary shrink-0" />
                          <a href={o.website} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors line-clamp-1">{o.website}</a>
                        </div>
                      )}
                    </div>
                    ...
                    {o.services && o.services.length > 0 && (
                      <div className="flex flex-wrap gap-1 pt-2 border-t border-border">
                        ...
                        {o.services.length > 3 && (
                          <Badge variant="outline" className="text-xs">+{o.services.length - 3}</Badge>
                        )}
                      </div>
                    )}
                  </div>
            ...
            {offices.length === 0 && (
              <div className="col-span-full text-center py-16">
                ...
                <h3 className="text-xl font-semibold mb-2 text-foreground">لا توجد مكاتب حالياً</h3>
                <p className="text-muted-foreground">لم يتم تسجيل أي مكاتب عقارية بعد</p>
              </div>
            )}
          </div>
        )}
