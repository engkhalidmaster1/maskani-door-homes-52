-- Drop role column if it's TEXT and recreate with proper type
DO $$
BEGIN
  -- Check if user_roles table exists and role column type
...
-- Create user_roles table with correct enum type
