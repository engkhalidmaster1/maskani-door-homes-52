...
-- ========================================
-- 2. Create Unified Permissions Table
-- ========================================
...
-- ========================================
-- 9. Data Migration from Old Tables
-- ========================================
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '📋 View Available:';
  RAISE NOTICE '   - users_with_permissions';
END $$;
